...
/*package*/ class Event_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      editorCell.setDefaultText("<event name>");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new parametersListHandler_ymj9mh_d0a(myNode, getEditorContext());
  ...
  private static class parametersListHandler_ymj9mh_d0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public parametersListHandler_ymj9mh_d0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(parametersListHandler_ymj9mh_d0a.this.getNode(), LINKS.parameters$xFqW));
      try {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new detectionRulesSingleRoleHandler_ymj9mh_b0(myNode, LINKS.detectionRules$WVw6, getEditorContext());
    return provider.createCell();
  }
  private static class detectionRulesSingleRoleHandler_ymj9mh_b0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public detectionRulesSingleRoleHandler_ymj9mh_b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.detectionRules$WVw6, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.detectionRules$WVw6, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.detectionRules$WVw6);
      }
      Style style = new StyleImpl();
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.detectionRules$WVw6));
      try {
        EditorCell editorCell = super.createEmptyCell();
        editorCell.setCellId("empty_detectionRules");
