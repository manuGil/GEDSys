...
/*package*/ class Condition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new LeftComparisonSingleRoleHandler_2lgv54_b0(myNode, LINKS.LeftComparison$Ic57, getEditorContext());
    return provider.createCell();
  }
  private static class LeftComparisonSingleRoleHandler_2lgv54_b0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public LeftComparisonSingleRoleHandler_2lgv54_b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.LeftComparison$Ic57, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.LeftComparison$Ic57, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.LeftComparison$Ic57);
      }
      Style style = new StyleImpl();
    ...
    protected EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.LeftComparison$Ic57));
      try {
        EditorCell editorCell = super.createEmptyCell();
        editorCell.setCellId("empty_LeftComparison");
  ...
  private EditorCell createRefNode_2() {
    SingleRoleCellProvider provider = new RightComparisonSingleRoleHandler_2lgv54_d0(myNode, LINKS.RightComparison$DgWG, getEditorContext());
    return provider.createCell();
  }
  private static class RightComparisonSingleRoleHandler_2lgv54_d0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public RightComparisonSingleRoleHandler_2lgv54_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.RightComparison$DgWG, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.RightComparison$DgWG, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.RightComparison$DgWG);
      }
      Style style = new StyleImpl();
      style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
      style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.RightComparison$DgWG));
      try {
        EditorCell editorCell = super.createEmptyCell();
        editorCell.setCellId("empty_RightComparison");
        installCellInfo(null, editorCell, true);
        setCellContext(editorCell);
        return editorCell;
      } finally {
