...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForDetectionExtent() {
    ...
    b.version(3);
    b.property("nameId", 0x562897dc3cfb22c3L).type(PrimitiveTypeId.STRING).origin("6208379058501919427").done();
  ...
  private static ConceptDescriptor createDescriptorForEvent() {
    ...
    b.version(3);
    b.aggregate("dataStreamLists", 0x562897dc3cfb2347L).target(0x35b540ea51fc45c2L, 0x8fb01d48ca99c3dbL, 0x562897dc3cfb22acL).optional(true).ordered(true).multiple(false).origin("6208379058501919559").done();
    b.alias("event");
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForSpatialGranulariy() {
    ...
    b.version(3);
    b.property("distance", 0x562897dc3cfb234fL).type(MetaIdFactory.dataTypeId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x494547eeedc219baL)).origin("6208379058501919567").done();
  ...
  private static ConceptDescriptor createDescriptorForTimeType() {
    ...
    b.version(3);
    b.aggregate("timeInstance", 0x562897dc3cfb235aL).target(0x35b540ea51fc45c2L, 0x8fb01d48ca99c3dbL, 0x562897dc3cfb2353L).optional(true).ordered(true).multiple(false).origin("6208379058501919578").done();
    b.alias("time type");
    return b.create();
  }
}
